...
func TestStdioProcess(t *testing.T) {
	...
	for _, name := range []string{
		"get_consumer_lag_overview", "get_consumer_lag_policy", "get_metric_series", "get_cluster_storage", "get_cluster_config_audit", "get_partition_reassignments", "get_consumer_target_throughput",
